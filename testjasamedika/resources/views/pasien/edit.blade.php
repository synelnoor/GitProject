        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal" action="{{ url('/pasien/edit') }}" method="POST">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input nama="nama" type="text" class="form-control" name="nama" value="{{ $data->nama }}">
                        ...
                        <div class="form-group{{ $errors->has('hp') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input hp="hp" type="text" class="form-control" name="hp" value="{{ $data->hp }}">
                        ...
                        <div class="form-group{{ $errors->has('rt') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input rt="rt" type="text" class="form-control" name="rt" value="{{ $data->rt_rw }}">
                        ...
                        <div class="form-group{{ $errors->has('kelurahan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input kelurahan="kelurahan" type="text" class="form-control" name="kelurahan" value="{{ $data->kelurahan }}">
                        ...
                        <div class="form-group{{ $errors->has('date') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input date="date" type="text" class="form-control" name="date" value="{{ $data->tanggal_lahir }}">
