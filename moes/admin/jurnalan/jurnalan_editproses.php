<?php
	...
	if($lokasi_gambar=="" | $lokasi_pdf==""){
		mysql_query("UPDATE jurnalan SET 
				judul	= '$_POST[judul]',
				isi		= '$isi',
				tanggal	= '$tanggal'
			WHERE id_jurnalan='$_POST[id]'") or die(mysql_error());
	}else{
		$data=mysql_fetch_array(mysql_query("select * from jurnalan where id_jurnalan='$_POST[id]'"));
