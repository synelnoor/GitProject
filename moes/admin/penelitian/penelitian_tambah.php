...
<h2 class="sub-header">Tambah Penelitian</h2>

<form name="tambah" method="post" action="?tampil=penelitian_tambahproses" enctype="multipart/form-data" class="form-horizontal">
