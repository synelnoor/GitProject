...
?>
<h2 class="sub-header">Tambah Gallery</h2>
<form name="tambah" method="post" action="?tampil=gallery_tambahproses" enctype="multipart/form-data" class="form-horizontal">
