<?php
	...
	$tampil = mysql_query("SELECT * FROM jurnal WHERE id_jurnal='$_GET[id]'") or die(mysql_error());
	$data  	= mysql_fetch_array($tampil);
?>

<h2 class="sub-header">Edit Jurnal</h2>

<form name="edit" method="post" action="?tampil=jurnal_editproses" enctype="multipart/form-data" class="form-horizontal">
	<input type="hidden" name="id" value="<?php echo $data['id_jurnal']; ?>">

		<div class="form-group">
			<label class="label-control col-md-2">Judul Jurnal</label>	
		...
		<div class="form-group">
			<label class="label-control col-md-2">Abstrak</label>			
