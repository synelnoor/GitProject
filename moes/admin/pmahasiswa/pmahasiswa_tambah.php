...
<h2 class="sub-header">Tambah Publikasi Mahasiswa</h2>

<form name="tambah" method="post" action="?tampil=pmahasiswa_tambahproses" enctype="multipart/form-data" class="form-horizontal">
