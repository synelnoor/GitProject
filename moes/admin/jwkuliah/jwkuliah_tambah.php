...
?>
<h2 class="sub-header">Tambah Jadwal Kuliah</h2>
<form name="tambah" method="post" action="?tampil=jwkuliah_tambahproses" enctype="multipart/form-data" class="form-horizontal">
