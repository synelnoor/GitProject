...
<h2 class="sub-header">Tambah Dokumen</h2>

<form name="tambah" method="post" action="?tampil=dokumen_tambahproses" enctype="multipart/form-data" class="form-horizontal">
