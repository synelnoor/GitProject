...
<h2 class="sub-header">Tambah Jurnal Hubungan Internasional</h2>

<form name="tambah" method="post" action="?tampil=jurnalhi_tambahproses" enctype="multipart/form-data" class="form-horizontal">
