...
<?php 
				...
				<?php 
					...
					if($hal > 1){
							echo "<span class='btn btn-warning'><a  href='?tampil=pendos&hal=1'> Pertama</a></span> ";
							echo "<span class='btn btn-warning'><a href='?tampil=pendos&hal=$sebelumnya'> Sebelumnya</a></span> ";
					}else{
						...
						else echo "<span class='btn btn-warning'><a href='?tampil=pendos&hal=$i'> $i </a></span> ";
						}
	
						if($hal < $jmlhal){
						echo "<span class='btn btn-warningt'><a href='?tampil=pendos&hal=$berikutnya'> Berikutnya </a></span> ";
						echo "<span class='btn btn-warning'><a href='?tampil=pendos&hal=$jmlhal'> Terakhir </a></span> ";
						}else{
